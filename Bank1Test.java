...
public class Bank1Test
{
    ...
    public void testCreate()
    {
        ...
        assertTrue("Error in testCreate",_bank1.getNameOfBank().equals("GenericBank"));
        assertEquals("Error in testCreate",0, _bank1.getNumOfAccounts());//create getNumOfAccounts later (not a required method)
    ...
    public void testDeposit()
    {
        ...
        _bank1.addAccount(new Account ("Will Smith", "911", new Money (1000)));
        _bank1.deposit("911", new Money (1000));
        
        Money expectedMoney = new Money (2000);
        
        Account actualAccount = _bank1.search("911");
    ...
    public void testWithdraw()
    {
        ...
        _bank1.addAccount(new Account ("Will Smith", "911", new Money (2000)));
        _bank1.withdraw("911", new Money (1000));
    ...
    public void testPrivacyLeak ()
    {
        ...
        _bank1.addAccount(test1);
        test1.deposit(new Money(1000));

        assertTrue("Error in testPrivacyLeak: Test 1", _bank1.search("911").getBalance().equals(new Money (2000)));
        ...
        _bank1.addAccount(test2);
        test2.withdraw(new Money(1000));
        
        assertTrue("Error in testPrivacyLeak: Test 2", _bank1.search("911").getBalance().equals(new Money (2000)));
        
        //Test 3: 
        Bank1 bank3 = new Bank1 ("Bank3");
